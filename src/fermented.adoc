...
. Choose a starter culture. I typically make a specific batch with cultures not seen in over-the-counter
yogurt (like https://cuttingedgecultures.com/lr-superfood/[L. Reuteri]
and https://cuttingedgecultures.com/l-gasseri-superfood-starter/[L. Gasseri]).  However, if you have a supermaket brand you like, and it's got live and active cultures in it, you can use it to make your own.
...
Just a few years ago, sous vide circulators were very expensive (> 1k).
These days, you can get one for less than a hundred dollars.
I've been using the cheapies from https://www.monoprice.com/product?p_id=21594[Monoprice] and they work fine.
They aren't the most rugged, and the temp can be off by a few degrees (use your kitchen Thermometer to check), but they work
just fine for most applications.  Bonus, no stupid WiFi or "guided cooking" programs to mess with.
...
The subsequent batches are usually thick and creamy.
